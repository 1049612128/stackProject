      ...
      <header class="header">
        ...
        <div class="navbar">
          <div class="navbar-left-container">
            <a href="/">
              <img class="navbar-brand-logo" src="static/imgs/logo.png" /></a>
          </div>
            ...
            <div class="accessory-list-wrap">
              <div class="accessory-list col-4">
                <ul>
                  <li>
                    <div class="pic">
                      <a href="#"><img src="static/imgs/1.jpg" alt=""></a>
                    </div>
                    <div class="main">
                  ...
                  <li>
                    <div class="pic">
                      <a href="#"><img src="static/imgs/2.jpg" alt=""></a>
                    </div>
                    <div class="main">
                      <div class="name">XX</div>
                  ...
                  <li>
                    <div class="pic">
                      <a href="#"><img src="static/imgs/3.jpg" alt=""></a>
                    </div>
                    <div class="main">
                      <div class="name">XX</div>
                  ...
                  <li>
                    <div class="pic">
                      <a href="#"><img src="static/imgs/4.jpg" alt=""></a>
                    </div>
                    <div class="main">
                      <div class="name">XX</div>
